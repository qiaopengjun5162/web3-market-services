...
const (
	MarketServices_GetSupportAsset_FullMethodName = "/web3_market_services.market.MarketServices/getSupportAsset"
	MarketServices_GetMarketPrice_FullMethodName  = "/web3_market_services.market.MarketServices/getMarketPrice"
)
...
var MarketServices_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "web3_market_services.market.MarketServices",
